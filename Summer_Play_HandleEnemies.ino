...
*/
                        if (isLeft) {
                            ...
                            // if (dist >= 34 && dist <= 120 && tile_R == Tiles::Blank) {    
                            ...
                            // }
                            // else if (dist >= 20 && dist <= 33 && tile_R == Tiles::Blank && a.randomLFSR(0, 5) == 0) {    
