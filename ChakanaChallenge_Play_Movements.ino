...
void processLadder_MoveLeft(Player &player, Tiles tile) {
    ...
    player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_LH_01) + start), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_LH_01) + end));
...
void processLadder_MoveRight(Player &player, Tiles tile) {
    ...
    player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_01) + start), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_01) + end));
...
//                    if ((counter >= 144 && counter < 208)) {
                    ...
                    if (counter < 52 || (counter >= 300 && counter < 352)) {
                ...
                player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_25_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_25_11) + stanceOffset));
                ...
                player.setFalls(0);
                player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_1D_25_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_1D_25_11) + stanceOffset));
                ...
                if (world.isWaterTile(tile_F2D2)) {
                    ...
                    if (itemIdx == Constants::NoItem) {
                        ...
                        player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Die_Water_RH_02_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Die_Water_RH_02_07) + stanceOffset));
                        player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_2D_25_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_2D_25_09) + stanceOffset));
                        ...
                        if (tile_D2 == Tiles::Water_Plain) {
                            ...
                            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_03) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_04) + stanceOffset));
                            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_25_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_25_11) + stanceOffset));
                            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_02) + stanceOffset));
                    ...
                    if (player.getLevel() != 2 && world.canWalkOnTile(tile_F3D3)) {
                        ...
                        player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_2D_25_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_2D_25_11) + stanceOffset));

                    }
                    else {
                        
                        player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_FallDown_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_FallDown_RH_06) + stanceOffset));
            ...
            if ((direction == Direction::Left  && world.isStairTile_R_Half(tile_D)) ||
                ...
                player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_Half_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_Half_04) + stanceOffset));

            }
            else if (world.canWalkOnTile(tile_F2D) && world.isEmptyTile(tile_F2) && world.isEmptyTile(tile_F2U) && world.isEmptyTile(tile_U)) {

                player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_2_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_WalkingJump_RH_2_08) + stanceOffset));

            }
            else if (world.isRopeSupport(tile_BU) && world.isRopeTile(tile_U)) {

                player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Rope_Start_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Rope_Start_RH_07) + stanceOffset));
        ...
        if (world.isVerticalVine_Upper(tile_F) || world.isVerticalVine_Middle(tile_F)) {
            ...
            player.setFalls(1);
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Vine_Entry_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Vine_Entry_RH_08) + stanceOffset));
            ...
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_Full_Land_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_Full_Land_13) + stanceOffset));

        }
        else if ((direction == Direction::Left  && world.isSlideTile_Full_RH(tile_FD) && !world.canWalkOnTile(tile_F3D2)) ||
                 (direction == Direction::Right && world.isSlideTile_Full_LH(tile_FD) && !world.canWalkOnTile(tile_F3D2))) {

            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_Full_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_Full_13) + stanceOffset));
            ...
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_Full_CanCont_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_Full_CanCont_12) + stanceOffset));
            ...
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Slide_RH_11) + stanceOffset));

        }
        else if ((direction == Direction::Left  && world.isStairTile_L1(tile_F)) ||
                 (direction == Direction::Right && world.isStairTile_R1(tile_F))) {

            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_ClimbStairs_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_ClimbStairs_RH_04) + stanceOffset));
            ...
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_ClimbStairs_RH_Half_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_ClimbStairs_RH_Half_04) + stanceOffset));
            ...
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_ClimbStairs_RH_05) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_ClimbStairs_RH_08) + stanceOffset));
            ...
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_05) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_08) + stanceOffset));

        }
        else if ((direction == Direction::Left  && world.isStairTile_R2(tile_FD)) ||
                 (direction == Direction::Right && world.isStairTile_L2(tile_FD))) {

            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_08) + stanceOffset));
            ...
            player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_DescendStairs_RH_04) + stanceOffset));
            ...
            if (pressed & A_BUTTON) {
                ...
                player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_Walk_RH_04) + stanceOffset));
            ...
            if (direction == Direction::Left) {
                ...
                if (world.getMiddleground() % 8 == 0 && world.canWalkPastTile(tile_F, Direction::Right)) {  // <<<<SJH should be left??
                    ...
                    processLadder_MoveLeft(player, static_cast<Tiles>(tile_FD));

                }       
                else if (world.canWalkPastTile(tile_F2, Direction::Left)) {

                    processLadder_MoveLeft(player, static_cast<Tiles>(tile_F));
                ...
                if (world.getMiddleground() % 8 == 0 && world.canWalkPastTile(tile_F, Direction::Right)) {  
                    ...
                    processLadder_MoveRight(player, static_cast<Tiles>(tile_F));

                }       
                else if (world.canWalkPastTile(tile_F2, Direction::Right)) {

                    processLadder_MoveRight(player, static_cast<Tiles>(tile_F2D));
            ...
            processLadder_MoveRight(player, static_cast<Tiles>(tile_FD));
            ...
            if (pressed & A_BUTTON) {
                ...
                if (!world.canWalkPastTile(tile_F) && world.canWalkOnTile(tile_F) && world.isEmptyTile(tile_U)) {     
                    ...
                    player.pushSequence(static_cast<Stance>(static_cast<uint16_t>(Stance::Man_StandingJump_RH_UPandOver_01) + stanceOffset), static_cast<Stance>(static_cast<uint16_t>(Stance::Man_StandingJump_RH_UPandOver_06) + stanceOffset));
