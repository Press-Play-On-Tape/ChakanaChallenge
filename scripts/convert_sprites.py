...
convert_header(IMAGES + 'Numbers/Numbers_5x3_3D_GB.png',                                                BASE + 'Images.hpp', 'Numbers_5x3_3D_GB', 4, 11, 8, maskImage=False)
...
convert_header(IMAGES + 'Health_Big.png',                                                               BASE + 'Images.hpp', 'Health_Big', 4, 49, 8)
convert_header(IMAGES + 'Chakana_Count.png',                                                            BASE + 'Images.hpp', 'Chakana_Count', 4, 40, 8)
