...
convert_header(IMAGES + 'Item_21.png',                                                            BASE + 'Images.hpp', 'Item_21', 4, 16, 16, maskImage=True)
convert_header(IMAGES + 'Item_21_Action_LH.png',                                                  BASE + 'Images.hpp', 'Item_21_Action_LH', 4, 38, 32, maskImage=True)
convert_header(IMAGES + 'Item_21_Action_RH.png',                                                  BASE + 'Images.hpp', 'Item_21_Action_RH', 4, 38, 32, maskImage=True)
...
convert_header(IMAGES + 'Crate_01_03.png',                                                        BASE + 'Images.hpp', 'Crate_01_03', 4, maskImage=True)
convert_header(IMAGES + 'Crate_01_04.png',                                                        BASE + 'Images.hpp', 'Crate_01_04', 4, maskImage=True)
...
convert_header(IMAGES + 'Crate_39.png',                                                        BASE + 'Images.hpp', 'Crate_39', 4, 16, 16, maskImage=True)
convert_header(IMAGES + 'Crate_40.png',                                                        BASE + 'Images.hpp', 'Crate_40', 4, 16, 16, maskImage=True)
convert_header(IMAGES + 'Crate_41.png',                                                        BASE + 'Images.hpp', 'Crate_41', 4, 16, 16, maskImage=True)
